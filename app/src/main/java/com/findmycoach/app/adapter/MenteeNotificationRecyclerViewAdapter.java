...
public class MenteeNotificationRecyclerViewAdapter extends RecyclerView.Adapter<MenteeNotificationRecyclerViewAdapter.ViewHolder> {
    ...
    private void actionDay(ViewHolder holder) {
        if (days == 0) {
            holder.tv_arrival_durations.setText(context.getResources().getString(R.string.today));
        } else {
            if (days == 1) {
                holder.tv_arrival_durations.setText(context.getResources().getString(R.string.yesterday));
            } else {
                holder.tv_arrival_durations.setText(days + " " + context.getResources().getString(R.string.days_ago));
            }
        }
    }
