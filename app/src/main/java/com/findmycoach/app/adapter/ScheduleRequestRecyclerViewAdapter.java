    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (no_schedule_request) {
            ...
            if (!status.equals("read")) {
                ...
                holder.tv_schedule_request_message.setTextColor(context.getResources().getColor(R.color.white));
                holder.tv_schedule_request_date_info.setTextColor(context.getResources().getColor(R.color.purple));
            }
