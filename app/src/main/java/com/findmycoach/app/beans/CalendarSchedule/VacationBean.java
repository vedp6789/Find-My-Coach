...
public class VacationBean implements Parcelable{
    ...
    public VacationBean(Parcel parcel){
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        public VacationBean createFromParcel(Parcel in) {
            return new VacationBean(in);
        }

        public VacationBean[] newArray(int size) {
            return new VacationBean[size];
        }
    };
