 ...
 */
public class SlotBean implements Parcelable{
    public SlotBean(){
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        public SlotBean createFromParcel(Parcel in) {
            return new SlotBean(in);
        }

        public SlotBean[] newArray(int size) {
            return new SlotBean[size];
        }
    };
}
