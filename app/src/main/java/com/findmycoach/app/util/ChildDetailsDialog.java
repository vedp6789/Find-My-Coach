...
public class ChildDetailsDialog implements  Callback {
    ...
    private void getGrades() {
        if (NetworkManager.isNetworkConnected(context)) {
            NetworkClient.getGrades(context, StorageHelper.getUserDetails(context, "auth_token"), this,54);
        } else
    ...
    public void successOperation(Object object, int statusCode, int calledApiValue) {
        ...
        try {
            ...
            gradeArrayList = new Gson().fromJson(jsonArray.toString(), new TypeToken<List<Grade>>(){}.getType());
